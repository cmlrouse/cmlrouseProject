...
<div class="container">
    ...
    <div class="movie">
        <div class="panel panel-success">
            ...
            <!-- List group -->
            <ul class="list-group">
                <?php if(is_array($movielist)): foreach($movielist as $key=>$mv): ?><a href="<?php echo U('Index/movieContent',array('evid'=>$mv['evid'],'userid'=>$userline['userid']));?>" class="list-group-item"><?php echo ($mv["evtitle"]); ?><span class="pull-right"><?php echo ($mv["evtime"]); ?></span></a><?php endforeach; endif; ?>
            </ul>
        </div>
    </div>
