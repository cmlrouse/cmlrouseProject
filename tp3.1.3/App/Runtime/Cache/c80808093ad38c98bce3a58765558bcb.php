    ...
    <div class="notice">
        <div class="panel panel-success">
            ...
            <div class="panel-heading">
        	 ...
        	 <ul class="list-group">
		<?php if(is_array($noticelist)): foreach($noticelist as $key=>$noticelist): ?><a href="<?php echo U('Index/noticeContent',array('noid'=>$noticelist['noid'],'userid'=>$userline['userid']));?>" class="list-group-item"><?php echo ($noticelist["notitle"]); ?><span class="pull-right"><?php echo ($noticelist["notime"]); ?></span></a><?php endforeach; endif; ?>
            </ul>
	</div>
    </div>
