...
<div class="container">
    ...
    <div class="movie">
        <div class="panel panel-success">
            ...
            <!-- List group -->
            <ul class="list-group">
                <?php if(is_array($mvlist)): foreach($mvlist as $key=>$mv): ?><li  class="list-group-item">
                        <?php echo ($mv["evtitle"]); ?>
                        <span class="pull-right">
                            <?php echo ($mv["evtime"]); ?>
                            <a href="<?php echo U('Admin/moviedel',array('evid'=>$mv['evid'],'userid'=>$mv['userid']));?>" class="btn btn-danger btn-xs" role="button">
                                删除
                            </a>
                            <a  href="<?php echo U('Admin/amovieContent',array('evid'=>$mv['evid'],'userid'=>$mv['userid']));?>" class="btn btn-success btn-xs"  target="_blank" role="button">
                                查看
                            </a>
                        </span>
