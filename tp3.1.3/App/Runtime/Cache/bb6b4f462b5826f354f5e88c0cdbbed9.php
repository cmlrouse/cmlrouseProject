                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo U('Admin/arrangenotice',array('userid'=>userline['userid']));?>">通知公告</a></li>
                                <li><a href="<?php echo U('Admin/arrangemovie',array('userid'=>userline['userid']));?>">影视交流</a></li>
                                <li><a href="<?php echo U('Admin/arrangeeveryday',array('userid'=>userline['userid']));?>">每日英语</a></li>
                            </ul>
                        </li>
            ...
            <ul class="list-group">
                <?php if(is_array($ntlist)): foreach($ntlist as $key=>$nt): ?><li  class="list-group-item">
                        ...
                        <span class="pull-right">
                            <?php echo ($nt["notime"]); ?>
                            <a href="<?php echo U('Admin/noticedel',array('noid'=>$nt['noid'],'userid'=>$userline['userid']));?>" class="btn btn-danger btn-xs">
                                删除
                            </a>
		
                            <a  href="<?php echo U('Admin/anoticeContent',array('noid'=>$nt['noid'],'userid'=>$nt['userid']));?>" class="btn btn-success btn-xs" target="_blank" role="button">
                                查看
                            </a>
                        </span>
